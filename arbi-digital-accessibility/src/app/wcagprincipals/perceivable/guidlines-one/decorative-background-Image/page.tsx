...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to correctly handle decorative background images to ensure they are ignored by screen readers and meet WCAG 1.1 accessibility compliance.",
};
export default function Page() {
  return (
    ...
    <PageScrollTop />
      ...
      <p className="plainText">
        Use an empty alt attribute <strong> (alt=&quot;&quot;)</strong> and ensure it is
        not announced by screen readers.
      </p>
      <h2 className="sub-title">SVG tag</h2>
      <p className="plainText">
        Add the attribute <strong> aria-hidden=&quot;true&quot;</strong> to Hides SVG from
        screen readers{" "}
      </p>
      <p className="plainText">
        Add <strong>focusable=&quot;false&quot;</strong> to Prevents keyboard tabbing
        (important in some browsers)
      </p>
      <p className="plainText">
        Add the
        <strong>role=&quot;presentation&quot;</strong> to Marks the SVG as visual-only
        (redundant but safe)
      </p>
      ...
      <h2 className="sub-title">With image tag</h2>
      <CodeSnippet
      ...
      <CodeSnippet
        ...
        language="html"
        label="Image tag Incorrect Code Usage"
      ...
      <div className={styles.demoFigure}>
        <Image
          ...
          width={400}
          height={400}
          className={`${styles.demoImage} ${styles.fullBorderImage}`}
        />
      </div>
